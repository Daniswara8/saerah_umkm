...
<body>
            ...
            <div class="navbar">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    ...
                    <form class="d-flex" role="search">
                        <input class="form-control me-2 custom" type="search" placeholder="Cari Disini"
                            aria-label="Search">
                        <button class="btn btn-outline-secondary rounded-pill bi bi-search cuzz"
                            type="submit"></button>
                    </form>
                    <a href="{{ url('/login') }}"><i class="bi bi-person-circle me-3"
                            style="margin-left:10px">Masuk</i></a>
                    <a href="/keranjang"><i class="bi bi-cart3 me-3"></i></a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <div class="opening d-flex">
        <div class="pembuka">
            <h2>Mari Jelajahi Koleksi <br>Fashion Kami yang<br>Eksklusif. <button class="getstarted"
                    id="scrollButton"><i class="bi bi-caret-right mb-2"></i>Get Started</button><br>
                    ...
                    <div class="carousel-item {{ $loop->first ? 'active' : '' }}">
                        <div class="d-flex justify-content-center">
                            @foreach ($productChunk as $product)
                                <div class="card me-4">
                                    <img src="{{ asset('assets/' . $product->foto_produk) }}"
                                        class="p-2 img-fluid gambar" style="margin-top: 10px;">
                                    <div class="card-body">
