            ...
            <div class="col-12" style="margin-left: 10px;">
                <div class="card border-1 shadow rounded"><br>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('product.update', $products->Slug_link) }}" enctype="multipart/form-data"
                            method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                @if ($products->foto_produk)
                                    <img src="{{ asset('assets/cache/' . $products->foto_produk) }}" alt="Saerah"
                                        class="img-fluid" style="width: 200px; margin-bottom: 15px; margin-top: 15px;">
                                @else
                                    <p>Tidak ada gambar yang tersedia</p>
                                @endif
                                <input type="file" class="form-control @error('foto_produk') is-invalid @enderror"
                                    name="foto_produk" {{ asset('assets/' . $products->foto_produk) }}>
                                @error('foto_produk')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                                    </div>
