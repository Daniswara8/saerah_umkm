    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Histori Data Customer</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active">Histori Data Customer</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                         ...
                         <td>
                             ...
                             @endif
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('customerAdmin.restore', $mtr->slug_link) }}"
                                            class="btn btn-warning text-white btn-sm" role="button">
                                            <i class="bi bi-box-arrow-up"></i>
                                        </a>
                                        <a href="{{ route('customerAdmin.forceDelete', $mtr->slug_link) }}"
