    ...
    <div class="row">
        ...
        <div class="col-12" style="margin-left: 10px;">
            <div class="card border-1 shadow rounded"><br>
             ...
             <center><h2>Hapus Data Produk</h2></center>

                <div class="card-body">

                    <form method="POST" action="{{ route('product.softdelete', $products->Slug_link) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                      ...
                      <div class="form-group">
                        ...
                        <img src="{{ asset('assets/' . $products->foto_produk) }}" alt="Saerah" class="img-fluid" style="width: 200px; margin: 15px;">
                        @else
