    ...
    <style>
        @media only screen and (max-width: 768px) {
            ...
            .container {
                ...
                /* Mengatur konten berurutan ke bawah */
            }
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            ...
            <div class="col-2 mt-2 ms-2">
                <img src="/assets/logosr.png" alt="" width="70px"
                    style="filter: drop-shadow(2px 1px 2px black);">
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                ...
                <form action="{{ route('search') }} " class="d-flex" role="search" method="GET">
                    <input class="form-control me-2 custom w-100" type="search" name="query"
                        placeholder="Cari Di Sini" aria-label="Search" value="{{ request('query') }}">
                    <button class="btn btn-outline-dark bi bi-search cuzz" type="submit"></button>
                </form>


                <a href="{{ route('dashboard.indexdashboard') }}"><i class="bi bi-person-circle" style="margin-left: 30px;"></i></a>
